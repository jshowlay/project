    ...
    <div className="min-h-screen" style={{ background:'#000', color:'#fff' }}>
      <div className="mx-auto max-w-6xl p-6">
        ...
        <section className="mt-4">
          ...
          {/* RESULTS GRID — 2 columns on ≥sm, 1 column on mobile */}
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {items.map(it=>{
              ...
              return (
                <div key={`${it.source}:${it.topic}:${String((it as any).observedAt ?? '')}`} className="rounded-2xl border border-[#1b1b1b] bg-[#0f0f0f] p-4">
                  {it.imageUrl && (
